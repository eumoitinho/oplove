...
const plans = [
  {
    ...
    popular: false,
    features: ["Perfil básico", "Responder mensagens", "Ver conteúdo público"],
  },
  {
    id: "gold",
    name: "Gold",
    price: 25,
    description: "Para quem quer mais conexões",
    icon: Star,
    color: "from-yellow-400 to-yellow-600",
    popular: true,
    features: ["Tudo do Free", "Enviar mensagens", "Upload de vídeos", "Criar eventos"],
  },
  {
    id: "diamond",
    name: "Diamond",
    ...
    popular: false,
    features: ["Tudo do Gold", "Grupos", "Stories", "Chamadas", "Sem anúncios"],
  },
  {
    id: "couple",
    name: "Couple",
    price: 69.9,
    description: "Para casais que querem compartilhar",
    icon: Users,
    color: "from-pink-400 to-red-600",
    popular: false,
    features: ["2 contas premium", "Recursos compartilhados", "Conteúdo exclusivo"],
  },
]
