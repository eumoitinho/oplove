...
export class StorageServerService {
  ...
  static async uploadFile({ userId, file, type }: ServerUploadOptions): Promise<UploadResult> {
    try {
      // Validate file
  ...
  // Create storage buckets if they don't exist (server-side admin function)
