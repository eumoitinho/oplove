-- Fix all permissions for authenticated users
...
GRANT ALL ON TABLE story_views TO authenticated;
GRANT ALL ON TABLE story_replies TO authenticated;
GRANT ALL ON TABLE user_credits TO authenticated;
GRANT ALL ON TABLE user_credit_transactions TO authenticated;
...
-- 6. Create permissive policies for follows table
...
-- 7. Create permissive policies for comments table
...
-- 8. Create permissive policies for posts table
...
-- 9. Create permissive policies for users table
...
-- 10. Create permissive policies for post_likes table
...
-- 11. Create permissive policies for notifications table
...
-- 12. Grant permissions to anon role for public data
